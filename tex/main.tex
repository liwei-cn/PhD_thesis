...
\chapter{A Physical Autonomous System for Inferring Agent Behaviors}\label{ch:swarm_physical_implementation}
\input{./subfiles/chapter_4.tex}

\chapter{Inferring Individual Behaviors Through Controlled Interaction}\label{ch:interaction}
