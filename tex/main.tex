...
\hypersetup{%
	pdfauthor = {Wei Li},
    pdftitle = {Automatic Learning of Agent Behaviors Through Machine Intelligence},
    %
...
\input{./subfiles/acknowledgments}
...
\input{./subfiles/chapter_1.tex}

\chapter{Background and Related Work}\label{ch:literature_review}
\input{./subfiles/chapter_2.tex}

\chapter{Reverse Engineering Swarm Behaviors using Metric-Free Coevolution}\label{ch:swarm_simulation}
\input{./subfiles/chapter_3.tex}
%
\chapter{A Physical Autonomous System for Learning Swarm Behaviors}\label{ch:swarm_physical_implementation}
\input{./subfiles/chapter_4.tex}

\chapter{Learning Individual Behaviors Through Controlled Interaction}\label{ch:interaction}
\input{./subfiles/chapter_5.tex}

\chapter{Conclusion}\label{ch:conclusion}
\input{./subfiles/chapter_6.tex}
